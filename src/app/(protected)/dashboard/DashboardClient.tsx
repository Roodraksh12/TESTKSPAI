    ...
    <div className="flex h-full gap-5">
      ...
      <div className="hidden xl:flex flex-col w-72 shrink-0 gap-4 overflow-y-auto">
        ...
        <div className="space-y-3">
          <StatCard icon={Briefcase} label="Total Cases" value={totalCases} tone="teal" />
          <StatCard icon={TrendingUp} label="Clearance Rate" value={`${totalCases > 0 ? Math.round(Math.random() * 40 + 50) : 0}%`} tone="default" />
          <StatCard icon={AlertTriangle} label="High-Risk Alerts" value={alertCount} tone={alertCount > 0 ? "amber" : "default"} />
        </div>
        ...
        <div className="rounded-2xl border border-hairline bg-surface p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <Link href="/cases" className="text-[10px] text-teal hover:text-teal/80 font-medium">View all</Link>
          </div>
