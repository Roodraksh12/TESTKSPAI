...
from app.services.case_access import person_in_scope_sql, station_filter_sql
...
def search(
    ...
    person_scope_sql, person_scope_params = person_in_scope_sql(is_sp, officer["stationId"], person_alias="p")
    suspect_clauses = []
